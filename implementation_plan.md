...
| Field     | References Table | References Field | Relationship                                                  |
| --------- | ---------------- | ---------------- | ------------------------------------------------------------- |
| parent_id | category         | id               | Self-referencing table allowing infinite nesting of category. |

## Constraints

- **Unique fields:** `slug` must be globally unique.
- **Nullable fields:** `parent_id` is null for top-level category.

## Suggested Indexes

| Index Name        | Fields | Reason                                                  |
| ----------------- | ------ | ------------------------------------------------------- |
| idx_category_slug | slug   | Used constantly by the frontend to load category pages. |
...
| Field       | References Table | References Field | Relationship                          |
| ----------- | ---------------- | ---------------- | ------------------------------------- |
| category_id | category         | id               | Many products belong to one category. |
